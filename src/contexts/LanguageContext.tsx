...
const translations: Record<Language, Record<string, string>> = {
  'en': {
    ...
    'project2Title': 'Gym Management API — Spring Boot',
    'project2Description': 'A Spring Boot REST API for gym management, featuring student registration, physical assessments, workout planning, and exercise tracking with JPA relationships.',
    'project3Title': 'MovixFlow — Logistics Backend',
    'project3Description': 'A .NET 8 backend for cargo escort and logistics management, featuring real-time route tracking, driver and vehicle management, trip scheduling, AI-powered document extraction, and WhatsApp integration.',
    'project4Title': 'Product Management API — Spring Boot',
    'project4Description': 'A Spring Boot REST API for product catalog management with full CRUD operations, global exception handling, and the DTO design pattern.',
  ...
  'pt-BR': {
    ...
    'project2Title': 'API de Gerenciamento de Academia — Spring Boot',
    'project2Description': 'Uma API REST Spring Boot para gerenciamento de academia, com cadastro de alunos, avaliações físicas, planejamento de treinos e controle de exercícios utilizando relacionamentos JPA.',
    'project3Title': 'MovixFlow — Backend de Logística',
    'project3Description': 'Backend em .NET 8 para gestão de escolta de cargas e logística, com rastreamento de rotas em tempo real, gerenciamento de motoristas e veículos, agendamento de viagens, extração de documentos com IA e integração com WhatsApp.',
    'project4Title': 'API de Gerenciamento de Produtos — Spring Boot',
    'project4Description': 'API REST Spring Boot para gerenciamento de catálogo de produtos com operações CRUD completas, tratamento global de exceções e padrão DTO.',
